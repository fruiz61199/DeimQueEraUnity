...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        public Transform numeroAros;
        public int aros;
        public int newArosCount;
        


        private void Start()
        {
            aros = numeroAros.childCount;
        ...
        {
            Pause();
            if(numeroAros.childCount == aros - 1)
            {
                GameManager.Instance.ChangeArosCount();
            }
            aros = numeroAros.childCount;
            if (numeroAros.childCount == 0)
            {
                GameManager.Instance.CheckArosCount();
            }
        }
        ...
        public void Pause()
        {
            if(GameManager.Instance.canvasActivo == true)
            {
                Time.timeScale = 0;
            }
            if (GameManager.Instance.canvasActivo == false)
            {
                Time.timeScale = 1;
            }
        }
        ...
        {
            if (other.gameObject.CompareTag("Aro"))
            {
